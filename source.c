...
/// \param[in] nom_client Le nom duu client pour  
...
/////////////////////////////////////////////////
///	\brief Afficher les commandes d'un client
/// en particulier.
/// 
/// \param[in] commandes Pointeur sur la 
/// structure représentant toutes les commandes.
...
void traite_progression(const Specialites* specialites, Commandes* commandes)
{
	...
	assert(commandes->tab_commandes[get_indice_commande(commandes, nom_commande)]
		.taches_par_specialite[get_indice_specialite(specialites, nom_specialite)]
		.nb_heures_requises != 0);
